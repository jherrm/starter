...
for app in /System/Library/CoreServices/Applications/* \
           ...
           "/System/Library/CoreServices/Network Diagnostics.app"; do
...
# Commenting out from error: "Operation not permitted"
...
# See: http://osxdaily.com/2011/11/02/enable-and-use-the-locate-command-in-the-mac-os-x-terminal/
